...
void LCDsendCommand(uint8_t cmd)	//Sends Command to LCD
{
	...
	hbyte=((cmd&0b11110000)>>4);
	lbyte=(cmd&0b00001111);
...
void LcdReadStatus(void)
{
	int i=1;
#ifdef LCD_4bit
	LDDR&=~((1<<LCD_D4)|(1<<LCD_D5)|(1<<LCD_D6)|(1<<LCD_D7));
	LDP|=(1<<LCD_D4)|(1<<LCD_D5)|(1<<LCD_D6)|(1<<LCD_D7);
#else
	LDD=0x00;
	LDP=0xff;
#endif
	...
	LCP&=~(1<<LCD_RW);
#ifdef LCD_4bit
	LDP&=(0<<LCD_D4)|(0<<LCD_D5)|(0<<LCD_D6)|(0<<LCD_D7);
	LDDR|=(1<<LCD_D4)|(1<<LCD_D5)|(1<<LCD_D6)|(1<<LCD_D7);
#else
	LDP=0x00;
	LDD=0xff;
